...
void AlgorithmManager::OnGuiRender()
{
	...
	Gui::BeginPropertyGrid("MainControllers", -1.0f);
	...
	Gui::BeginPropertyGrid("Elements", -1.0f);
	...
	Gui::Image(CurrentPaletteTexture(), sf::Vector2f(ImGui::GetContentRegionAvailWidth(), 9.0f), sf::Color::White, sf::Color::Transparent);

	ImGui::Separator();

	ImGui::Text("Algorithms");
	Gui::BeginPropertyGrid("Checkboxes", -1.0f);
